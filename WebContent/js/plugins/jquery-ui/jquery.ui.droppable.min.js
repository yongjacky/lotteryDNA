 ...
 */(function(e, t) {
					...
					"ui.droppable",
					{
						...
						_over : function(t) {
							...
							if (!n
								...
								return;
							if (this.accept.call(this.element[0], n.currentItem
									|| n.element)) {
						...
						_drop : function(t, n) {
							...
							if (!r
									|| (r.currentItem || r.element)[0] === this.element[0])
								return !1;
							this.element
							...
							if (i)
								return !1;
							if (this.accept.call(this.element[0], r.currentItem
									|| r.element)) {
								this.options.activeClass
										&& this.element
												.removeClass(this.options.activeClass);
	...
	e.ui.ddmanager = {
		...
		prepareOffsets : function(t, n) {
			var r, i, s = e.ui.ddmanager.droppables[t.options.scope] || [], o = n ? n.type
					: null, u = (t.currentItem || t.element).find(
