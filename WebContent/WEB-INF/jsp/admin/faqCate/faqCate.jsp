			...
			<div class="row">
					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding">
							<table id="table1"
								...
								<thead>
									<tr class="thefilter">
										<th><fmt:message key="FaqCate.name" /></th>
										<th><fmt:message key="FaqCate.enable" /></th>
										<th><fmt:message key="FaqCate.defaultLangId" /></th>
										<th><fmt:message key="FaqCate.otherLang" /></th>
								...
								<tbody>
									<c:forEach var="item" varStatus="status"
										...
										<tr>
											<td><a href="${ctx}/admin/faqCate/${item.id}/edit">
											...
											<td><a href="${ctx}/admin/faqCate/${item.id}/delete"
				...
				<div class="form-actions">
					<input type="submit" class='btn btn-primary'
						...
						onclick="location.href='${ctx}/admin/faqCate/add';">
				</div>
			</div>
		</div>
	</div>
