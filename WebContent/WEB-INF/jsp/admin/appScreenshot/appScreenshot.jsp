			...
			<div class="row">
					...
					<div class="box box-color box-bordered">
						<div class="box-title">
							<h3>
								...
								<fmt:message key="AppScreenshot.list" />
							</h3>
						</div>
						<div class="box-content nopadding">
							<table id="table1"
								...
								<thead>
									<tr class="thefilter">
										<th><fmt:message key="AppScreenshot.appScreenshotTypeId" /></th>
								...
								<tbody>
									<c:forEach var="item" varStatus="status"
										...
										<tr>
											<td><a href="${ctx}/admin/appScreenshot/${item.id}/edit">
													<c:out value='${item.appScreenshotType.formfactorType}' />
											</a></td>
											...
											<td><a
												href="${ctx}/admin/appScreenshot/${item.id}/delete"
				...
				<div class="form-actions">
					<input type="submit" class='btn btn-primary'
						...
						onclick="location.href='${ctx}/admin/appScreenshot/add';">
				</div>
			</div>
		</div>
	</div>
