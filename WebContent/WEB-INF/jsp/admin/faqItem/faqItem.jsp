			...
			<div class="row">
					...
					<div class="box box-color box-bordered">
						...
						<div class="box-content nopadding">
							<table id="table1"
								...
								<thead>
									<tr class="thefilter">
										<th><fmt:message key="FaqItem.question" /></th>
										<th><fmt:message key="FaqItem.faqCateId" /></th>
										<th><fmt:message key="FaqItem.enable" /></th>
										<th><fmt:message key="FaqItem.defaultLangId" /></th>
										<th><fmt:message key="FaqItem.otherLang" /></th>
								...
								<tbody>
									<c:forEach var="item" varStatus="status"
										...
										<tr>
											<td><a href="${ctx}/admin/faqItem/${item.id}/edit">
													<c:out value='${item.question}' />
											</a></td>
											<td><c:out value='${item.faqCate.name}' />&nbsp;</td>
											...
											<td><a href="${ctx}/admin/faqItem/${item.id}/delete"
				...
				<div class="form-actions">
					<input type="submit" class='btn btn-primary'
						...
						onclick="location.href='${ctx}/admin/faqItem/add';">
				</div>
			</div>
		</div>
	</div>
