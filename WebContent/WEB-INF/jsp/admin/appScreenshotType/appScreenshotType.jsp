	...
	<div id="main">
		<div class="container-fluid" style="width: 100%">
			<div class="page-header">
				<div class="pull-left">
					<h1>
						<fmt:message key="AppScreenshotType" />
					</h1>
				</div>
			</div>
			<!-- content -->
			<div class="row">
					...
					<div class="box box-color box-bordered">
						<div class="box-title">
							<h3>
								...
								<fmt:message key="AppScreenshotType.list" />
							</h3>
						</div>
						<div class="box-content nopadding">
							<table id="table1"
								...
								<thead>
									<tr class="thefilter">
										<th><fmt:message key="AppScreenshotType.appInfoId" /></th>
										<th><fmt:message key="AppScreenshotType.formfactorType" /></th>
								...
								<tbody>
									<c:forEach var="item" varStatus="status"
										...
										<tr>
											<td><a href="${ctx}/admin/appScreenshotType/${item.id}/edit">
													<c:out value='${item.appInfo.appName}' />
											</a></td>
											<td><c:out value='${item.formfactorType}' />&nbsp;</td>
											...
											<td><a
												href="${ctx}/admin/appScreenshotType/${item.id}/delete"
				...
				<div class="form-actions">
					<input type="submit" class='btn btn-primary'
						...
						onclick="location.href='${ctx}/admin/appScreenshotType/add';">
				</div>
			</div>
		</div>
	</div>
